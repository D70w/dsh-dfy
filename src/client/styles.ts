...
[data-whale-work-fx][data-thinking-stage=waiting] .whale-thinking-object,[data-whale-work-fx][data-thinking-stage=analyzing] .whale-thinking-object,[data-whale-work-fx][data-thinking-stage=organizing] .whale-thinking-object{position:absolute;display:grid;width:72px;height:72px;place-items:center;opacity:0;filter:drop-shadow(0 6px 7px rgba(35,63,124,.2));will-change:transform,opacity}
[data-whale-work-fx][data-thinking-stage=waiting] .whale-thinking-object{left:74%;top:16%;animation:whale-thinking-wait-in 1.4s cubic-bezier(.16,1,.3,1) forwards}
[data-whale-work-fx][data-thinking-stage=analyzing] .whale-thinking-object{left:72%;top:14%;animation:whale-thinking-analyze-in 1.4s cubic-bezier(.16,1,.3,1) forwards}
[data-whale-work-fx][data-thinking-stage=organizing] .whale-thinking-object{left:72%;top:19%;animation:whale-thinking-notes-in 1.4s cubic-bezier(.16,1,.3,1) forwards}
.whale-thinking-icon{width:100%;height:100%;overflow:visible}.thinking-wait-tag{fill:#f8fbff;stroke:#7895c7;stroke-width:3;stroke-linejoin:round}.thinking-wait-fold{fill:none;stroke:#7895c7;stroke-width:2.6;stroke-linejoin:round}.thinking-wait-dot{fill:#6e9bd5;animation:whale-thinking-dot 1.1s ease-in-out infinite alternate}.thinking-wait-dot:nth-of-type(2){animation-delay:-.22s}.thinking-wait-dot:nth-of-type(3){animation-delay:-.44s}.thinking-wait-line{stroke:#aec4e8;stroke-width:3;stroke-linecap:round}.thinking-wait-glint{fill:#fff1aa;animation:whale-result-glint 1.35s ease-in-out infinite alternate}
.thinking-analyze-board{fill:#f7fbff;stroke:#728fc5;stroke-width:3}.thinking-analyze-line{stroke:#8ca8d8;stroke-width:3;stroke-linecap:round}.thinking-analyze-lens{fill:rgba(173,224,250,.48);stroke:#4d8dbd;stroke-width:4}.thinking-analyze-handle{stroke:#4267a4;stroke-width:5;stroke-linecap:round}.thinking-analyze-scan{stroke:#fff;stroke-width:2.5;stroke-linecap:round;stroke-dasharray:4 3;animation:whale-work-scan-line 1.25s linear infinite}.thinking-analyze-glint{fill:#fff1aa;animation:whale-result-glint 1.2s ease-in-out infinite alternate}
.thinking-notes-back{fill:#d8e7ff;stroke:#718bc0;stroke-width:3;stroke-linejoin:round}.thinking-notes-front{fill:#fffdf5;stroke:#6d89c0;stroke-width:3;stroke-linejoin:round}.thinking-notes-line{stroke:#8fa7d2;stroke-width:2.6;stroke-linecap:round}.thinking-notes-clip{fill:none;stroke:#6c88be;stroke-width:3;stroke-linecap:round}.thinking-notes-check{fill:none;stroke:#4f9c7c;stroke-width:4;stroke-linecap:round;stroke-linejoin:round}.thinking-notes-glint{fill:#fff1aa;animation:whale-result-glint 1.25s ease-in-out infinite alternate}
 [data-whale-pet-stage][data-whale-bubble-side=right] [data-whale-work-fx][data-thinking-stage=waiting] .whale-thinking-object,[data-whale-pet-stage][data-whale-bubble-side=right] [data-whale-work-fx][data-thinking-stage=analyzing] .whale-thinking-object,[data-whale-pet-stage][data-whale-bubble-side=right] [data-whale-work-fx][data-thinking-stage=organizing] .whale-thinking-object{left:20%}
...
@media (prefers-reduced-motion:reduce){.whale-work-object,.whale-work-icon,.whale-result-object,.whale-thinking-object{animation:none;opacity:.96}}
...
@keyframes whale-thinking-wait-in{0%{opacity:0;transform:translate(-50%,8px) scale(.7)}24%{opacity:1;transform:translate(-50%,-1px) scale(1.05)}48%{transform:translate(-50%,0) scale(1)}100%{opacity:.9;transform:translate(-50%,-2px) scale(1)}}
@keyframes whale-thinking-analyze-in{0%{opacity:0;transform:translate(-50%,8px) rotate(-10deg) scale(.7)}24%{opacity:1;transform:translate(-50%,-2px) rotate(5deg) scale(1.06)}48%{transform:translate(-50%,0) rotate(-2deg) scale(1)}100%{opacity:.96;transform:translate(-50%,-2px) rotate(2deg) scale(1.02)}}
@keyframes whale-thinking-notes-in{0%{opacity:0;transform:translate(-50%,9px) rotate(8deg) scale(.7)}24%{opacity:1;transform:translate(-50%,-1px) rotate(-4deg) scale(1.05)}48%{transform:translate(-50%,0) rotate(2deg) scale(1)}100%{opacity:.96;transform:translate(-50%,-2px) rotate(-1deg) scale(1.02)}}
@keyframes whale-thinking-dot{from{opacity:.35;transform:translateY(2px) scale(.86)}to{opacity:1;transform:translateY(-2px) scale(1.08)}}
